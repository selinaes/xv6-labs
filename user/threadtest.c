...
int test3(){
    ...
    int thread_pid1 = thread_create(heaptest, &arg1, &arg2);
    // printf("arg1 is %d\n",arg1);
    // printf("arg2 is %d\n",arg2);

    int thread_pid2 = thread_create(emptytest, &arg1, &arg2);
    int thread_pid3 = thread_create(stacktest, &arg1, &arg2);

    assert(thread_pid1 > 0);
    // printf("thread_pid1 is %d\n",thread_pid1);
    assert(thread_pid2 > 0);
    // printf("thread_pid2 is %d\n",thread_pid2);
